...
#from uavblog import db,login_manager,app#we are importing app since we need the  app's secret key-we are going to remove the app since we created a function that acts as a blueprint for the app creation
from uavblog import db,login_manager#we are importing app since we need the  app's secret key
